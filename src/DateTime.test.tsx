  ...
  describe("day picker", () => {
    it("should open day picker when clicking", () => {
      ...
      const { getByLabelText } = render(
        <>
          <label htmlFor="some-id">Some Field</label>
          <DateTime id="some-id" dateFormat="MM/DD/YYYY" />
        </>
      );
    ...
    it("should choose day from picker", () => {
      ...
      const { getByLabelText } = render(
        <>
          <label htmlFor="some-id">Some Field</label>
          <DateTime id="some-id" dateFormat="MM/DD/YYYY" timeFormat={false} />
        </>
      );
  ...
  describe("month picker", () => {
    it("should open month picker when clicking", () => {
      ...
      const { getByLabelText } = render(
        <>
          <label htmlFor="some-id">Some Field</label>
          <DateTime id="some-id" dateFormat="MM/YYYY" />
        </>
      );
    ...
    it("should choose month from picker", () => {
      ...
      const { getByLabelText } = render(
        <>
          <label htmlFor="some-id">Some Field</label>
          <DateTime id="some-id" dateFormat="MM/YYYY" timeFormat={false} />
        </>
      );
  ...
  describe("switchers", () => {
    ...
    it("should switch to 'time mode' when time picker is supported", () => {
      ...
      const { getByLabelText } = render(
        <>
          <label htmlFor="some-id">Some Field</label>
          <DateTime id="some-id" dateFormat="MM/DD/YYYY" timeFormat="h:mm A" />
        </>
      );
